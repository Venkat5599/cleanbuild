        ...
        >
          ...
          <h1 className="text-8xl max-[850px]:text-5xl font-medium tracking-tight leading-[1.1] mb-6 text-black">
            ...
            <motion.span
              ...
              transition={{ duration: 0.8, ease }}
            >
              Start <span className="italic font-serif text-accent">recording them.</span>
            </motion.span>
          </h1>
          ...
          <motion.p
            ...
            transition={{ duration: 0.8, ease }}
          >
            The result is collected days later, corrected for the things you do not control, and folded into a model of your audience that never resets.
          </motion.p>
          ...
          >
            ...
            <span className="relative z-10 px-6 py-3 rounded-xl bg-black text-white font-medium max-[850px]:flex-1">See what it learned</span>
